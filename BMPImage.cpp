...
#ifdef MAC_OS
void BMPImage::swapTwoBytes (unsigned short* s)
{
    char *j = (char *) s;
    j[0] ^= j[1];
    j[1] ^= j[0];
...
void BMPImage::swapFourBytes (unsigned long* l)
{
    char *j = (char *) l;
    j[0] ^= j[3];
    j[3] ^= j[0];
...
#else
void BMPImage::swapTwoBytes (unsigned short* w) {}
void BMPImage::swapFourBytes (unsigned long* dw) {}
#endif
